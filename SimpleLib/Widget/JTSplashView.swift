...
class JTSplashView: UIView {
    ...
    func doInit() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(JTSplashView.addToWindow), name: UIWindowDidBecomeVisibleNotification, object: nil)
    }
    ...
    private func createBaseCircle() {
        ...
        enlarge()
        NSTimer.scheduledTimerWithTimeInterval(duration, target: self, selector: #selector(JTSplashView.vibration), userInfo: nil, repeats: false)
    ...
    private func zoomOut() {
        ...
        NSTimer.scheduledTimerWithTimeInterval(shrinkAnimation.duration, target: self, selector: #selector(JTSplashView.fadeOut), userInfo: nil, repeats: false)
        NSTimer.scheduledTimerWithTimeInterval(shrinkAnimation.duration, target: self, selector: #selector(JTSplashView.zoomIn), userInfo: nil, repeats: false)
    }
    ...
    @objc private func vibration() {
        ...
        if vibrateAgain {
            NSTimer.scheduledTimerWithTimeInterval(duration * 4, target: self, selector: #selector(JTSplashView.vibration), userInfo: nil, repeats: false)
        } else {
            finalAnimation()
        }
    }
