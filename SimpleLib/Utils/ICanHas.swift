        ...
        onMain {
            ...
            if !ICanHas.isHasingLocation {
                ...
                case .AuthorizedAlways:
                    print("status is always", terminator: "")
                    callback(true)
                case .Denied:
                    print("status is denied", terminator: "")
                    callback(false)
                case .Restricted:
                    print("status is restricted", terminator: "")
                    callback(false)
                case .AuthorizedWhenInUse:
                    print("status is when in use", terminator: "")
                    if background {
                        fallthrough
                    }else {
                        callback(true)
                ...
                case .NotDetermined:
                    print("status is not determined", terminator: "")
...
//                    }
                    ...
                    if background {
                        ...
                        print("RIGHT NOW REQUESTING!!!!!", terminator: "")
